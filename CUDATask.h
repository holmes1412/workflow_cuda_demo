...
protected:
	virtual SubTask *done()
	{
		...
		fprintf(stderr, "done() stream addr %lu\n", this->stream);
...
template<class INPUT, class OUTPUT>
class CudaSyncTask : public WFThreadTask<INPUT, OUTPUT>
{
public:
...
*/
	...
	CudaSyncTask(ExecQueue *queue, Executor *executor,
			 	cudaStream_t stream,
